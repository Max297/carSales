 ...
 */
final class Version20241215134029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE credit_programm (id INT AUTO_INCREMENT NOT NULL, interest_rate DOUBLE PRECISION NOT NULL, monthly_payment INT NOT NULL, title VARCHAR(500) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
